...
CONF_CALIBRATION_SOURCE = "source"
CONF_OPEN_SAMPLES = "open_samples"
CONF_CLOSE_SAMPLES = "close_samples"

CALIBRATION_SOURCE_GUIDED_HA = "guided_home_assistant"
CALIBRATION_SOURCE_GUIDED_PICO = "guided_pico"
